  ...
  return (
    <Base>
        ...
        <TypeList>
            {
                types?.map(({type}, idx)=>(
                    <TypeWrapper key={idx} color={mapTypeToHex(color?.name)}>
        ...
        <InfoContainerWrapper>
            ...
            <InfoConatainer>
                ...
                <InfoItem>
                    ...
                    <InfoItemValue color={mapColorToHex(color?.name)}>{genderRate === -1 ? 'Unknwon' : 'Maile/Female'}</InfoItemValue>
                </InfoItem>
                <InfoItem>
